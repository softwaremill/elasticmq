...
* runs stand-alone ([download](https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-1.1.0.jar)), via [Docker](https://hub.docker.com/r/softwaremill/elasticmq-native/) or embedded
...
[https://s3/.../elasticmq-server-1.1.0.jar](https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-1.1.0.jar)
...
configuration values, create a file (e.g. `custom.conf`), fill it in with the desired values, and pass it to the server:
    ...
    java -Dconfig.file=custom.conf -jar elasticmq-server-1.1.0.jar
...
log INFO logs and above to the console):
    ...
    java -Dlogback.configurationFile=my_logback.xml -jar elasticmq-server-1.1.0.jar
...
Add ElasticMQ Server to `build.sbt` dependencies
    ...
    libraryDependencies += "org.elasticmq" %% "elasticmq-server" % "1.1.0"
