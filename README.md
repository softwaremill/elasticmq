...
[https://s3/.../elasticmq-server-1.1.1.jar](https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-1.1.1.jar)
...
ENV ELASTICMQ_VERSION ${ELASTICMQ_VERSION:-1.1.1}
