...
* runs stand-alone ([download](https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-v1.4.2.jar)), via [Docker](https://hub.docker.com/r/softwaremill/elasticmq-native/) or embedded
...
[https://s3/.../elasticmq-server-v1.4.2.jar](https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-v1.4.2.jar)
...
```
java -jar elasticmq-server-v1.4.2.jar
```
...
```
java -Dconfig.file=custom.conf -jar elasticmq-server-v1.4.2.jar
```
...
```
java -Dlogback.configurationFile=my_logback.xml -jar elasticmq-server-v1.4.2.jar
```
...
```scala
libraryDependencies += "org.elasticmq" %% "elasticmq-server" % "v1.4.2"
```
...
ENV ELASTICMQ_VERSION ${ELASTICMQ_VERSION:-v1.4.2}
...
```scala
// Scala 2.13 and 2.12
val elasticmqSqs        = "org.elasticmq" %% "elasticmq-rest-sqs" % "v1.4.2"
```
...
```scala
val elasticmqCore       = "org.elasticmq" %% "elasticmq-core" % "v1.4.2"
```
