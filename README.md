...
* runs stand-alone ([download](https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-0.8.0.jar)) or embedded
...
[https://s3/.../elasticmq-server-0.8.0.jar](https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-0.8.0.jar)
...
log INFO logs and above to the console):
    ...
    java -Dlogback.configurationFile=my_logback.xml -jar elasticmq-server-0.8.0.jar
...
-----------------------------
    ...
    // Scala 2.11
    val elasticmqSqs        = "org.elasticmq" %% "elasticmq-rest-sqs"         % "0.8.0"
...
module:
    ...
    val elasticmqCore       = "org.elasticmq" %% "elasticmq-core"             % "0.8.0"

Repository:

    resolvers += "SoftwareMill Releases" at "https://nexus.softwaremill.com/content/repositories/releases"

(ElasticMQ 0.8.0 cannot be deployed to Maven Central as its dependency - Spray - isn't deployed there yet.)
