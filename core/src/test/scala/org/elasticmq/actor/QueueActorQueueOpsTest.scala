...
class QueueActorQueueOpsTestWithInMemoryQueues extends QueueActorQueueOpsTest with MessagePersistenceDisabledConfig

class QueueActorQueueOpsTestWithPersistenceQueues extends QueueActorQueueOpsTest with MessagePersistenceEnabledConfig
