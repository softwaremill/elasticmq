...
val amazonJavaSdk = "com.amazonaws" % "aws-java-sdk" % "1.11.592" exclude ("commons-logging", "commons-logging")
...
lazy val nativeServer: Project = (project in file("native-server"))
  ...
  .settings(Seq(
    ...
    libraryDependencies += "com.oracle.substratevm" % "svm" % "19.1.0" % Provided,
    mainClass in assembly := Some("org.elasticmq.server.Main"),
