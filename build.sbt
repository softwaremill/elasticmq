...
val jclOverSlf4j = "org.slf4j" % "jcl-over-slf4j" % "2.0.11" // needed form amazon java sdk
...
val scala3Async =
  "com.github.rssh" %% "shim-scala-async-dotty-cps-async" % "0.9.20" // allows cross compilation w/o changes in source code

val scalikeJdbc = "org.scalikejdbc" %% "scalikejdbc" % "4.2.0"
